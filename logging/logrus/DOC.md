...
## <a name="DefaultMiddlewareCodeToLevel">func</a> [DefaultMiddlewareCodeToLevel](./options.go#L106)
...
## <a name="DefaultTripperwareCodeToLevel">func</a> [DefaultTripperwareCodeToLevel](./options.go#L119)
...
## <a name="CodeToLevel">type</a> [CodeToLevel](./options.go#L55)
...
## <a name="Option">type</a> [Option](./options.go#L52)
...
### <a name="WithConnectivityErrorLevel">func</a> [WithConnectivityErrorLevel](./options.go#L68)
...
### <a name="WithLevels">func</a> [WithLevels](./options.go#L61)
...
### <a name="WithRequestBodyCapture">func</a> [WithRequestBodyCapture](./options.go#L86)
...
### <a name="WithRequestFieldExtractor">func</a> [WithRequestFieldExtractor](./options.go#L130)
``` go
...
### <a name="WithResponseBodyCapture">func</a> [WithResponseBodyCapture](./options.go#L99)
...
### <a name="WithResponseFieldExtractor">func</a> [WithResponseFieldExtractor](./options.go#L137)
``` go
...
## <a name="RequestFieldExtractorFunc">type</a> [RequestFieldExtractorFunc](./options.go#L144)
``` go
...
## <a name="ResponseFieldExtractorFunc">type</a> [ResponseFieldExtractorFunc](./options.go#L147)
``` go
type ResponseFieldExtractorFunc func(res httpwares.WrappedResponseWriter, req *http.Request) map[string]interface{}
```
